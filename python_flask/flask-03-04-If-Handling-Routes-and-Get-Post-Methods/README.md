...
Bu uygulamaların amacı, öğrencilere formların nasıl işleneceğine dair tanıtım bilgisini vermektir.

![HTTP Methods in Flask](./http-methods-flask.png)

## Öğrenme Çıktıları

Bu uygulamaların sonunda öğrenciler;

- Şişe çerçeveli basit bir web uygulaması oluşturun.

- HTTP istek-cevap döngüsünü ve URL'nin yapısını anlayın.

- Şişe ile rotalar (veya görünümler) oluşturun.

- Şişeyi kullanarak statik içerik ve dosyalara servis yapın.

- HTML şablonlarını kullanarak dinamik içeriğe hizmet edin.

- Jinja şablon motorunu kullanarak HTML şablonları yazın.

- Python Flask Framework ile bir web uygulaması oluşturun.

- Koşullar ve şişeleri olan döngüler için oluşturun.

- Şişeyi kullanarak formları ve GET-POST yöntemlerini kullanın.
